...
#[utoipa::path(
    ...
    responses((status = OK, body = super::models::Isolate))
)]
pub async fn get_one(
    ...
    let obj: super::models::Isolate = obj.clone().into();
...
#[utoipa::path(
    post,
    path = format!("/api/{}", RESOURCE_NAME),
    responses((status = CREATED, body = super::models::Isolate))
)]
pub async fn create_one(
    State(db): State<DatabaseConnection>,
    Json(payload): Json<super::models::IsolateCreate>,
) -> Result<(StatusCode, Json<super::models::Isolate>), (StatusCode, Json<String>)> {
...
pub async fn update_one(
    State(db): State<DatabaseConnection>,
    Path(id): Path<Uuid>,
    Json(payload): Json<super::models::IsolateUpdate>,
) -> impl IntoResponse {
    ...
    let response_obj: super::models::Isolate = updated_obj.update(&db).await.unwrap().into();
