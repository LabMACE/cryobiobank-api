...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(r#"ALTER TABLE samples DROP COLUMN type_of_sample"#)
            .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(r#"ALTER TABLE samples ADD COLUMN type_of_sample TEXT NULL"#)
            .await?;

        // Make isolates.sample_type nullable again
        db.execute_unprepared(r#"ALTER TABLE isolates ALTER COLUMN sample_type DROP NOT NULL"#)
            .await?;
